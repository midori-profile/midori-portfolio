...
Master Node(a node refers to a virtual machine.): This is the brain of the entire k8s system. It decides where the containers should run and when to scale them…
